...
async function listarResumenAsistencia(){
    try {
        ...
        const response = await fetch(`/api/asistencias/resumen_asistencias?year=${year}&month=${month}&fortnight=${fortnight}`, {
            method: 'GET',
...
async function listarAsistencia() {
    try {
        ...
        const response = await fetch(`/api/asistencias?year=${year}&month=${month}&fortnight=${fortnight}`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });

...
async function obtenerVehiculo() {
    try {
        ...
        const response = await fetch(`/api/vehiculos/vehiculo?pkVehiculo=${pkVehiculo}`, {
            method: 'GET',
...
async function listarServiciosVehiculo() {
    try {
        ...
        const response = await fetch(`/api/servicios_vehiculo/servicio_vehiculo?fkVehiculo=${fkVehiculo}`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
...
async function agregarServicioVehiculo() {
    ...
    try {
        ...
        const response = await fetch('/api/servicios_vehiculo', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },

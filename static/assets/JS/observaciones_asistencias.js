...
async function obtenerObservacion() {
    try {
        ...
        const response = await fetch(`/api/asistencias/observaciones?year=${year}&month=${month}&fortnight=${fortnight}`, {
            method: 'GET',
...
async function guardarObservacion() {
    ...
    try {
        ...
        const response = await fetch('/api/asistencias/observaciones', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },

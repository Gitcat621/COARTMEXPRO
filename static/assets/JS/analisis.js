...
async function cargarMetricas(meses) {
    ...
    try {
        ...
        const response = await fetch(`/api/analisis/resumenes?${params.toString()}&year=${year}`);
...
async function cargarTops(meses) {
    ...
    try {
        const response = await fetch(`/api/analisis/tops?${params.toString()}`);
...
async function cargarMetricasServicio(meses) {
    ...
    try {
        const response = await fetch(`/api/analisis/detalles?${params.toString()}&year=${year}`, {
            method: 'GET',
            headers: {

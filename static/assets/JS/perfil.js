...
async function obtenerEmpleado(numeroEmpleado) {
    try {
        const response = await fetch(`/api/empleados/empleado?numeroEmpleado=${numeroEmpleado}`, {
            method: 'GET',
...
async function obtenerCursosEmpleado(numeroEmpleado) {
    try {
        const response = await fetch(`/api/empleados/cursos_empleado?numeroEmpleado=${numeroEmpleado}`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
        const data = await response.json();
...
async function obtenerPermisosEmpleado(numeroEmpleado) {
    try {
        const response = await fetch(`/api/empleados/permisos_empleado?numeroEmpleado=${numeroEmpleado}`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
        const data = await response.json();
...
async function obtenerOportunidadesEmpleado(numeroEmpleado) {
    try {
        const response = await fetch(`/api/empleados/oportunidad_empleado?numeroEmpleado=${numeroEmpleado}`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
        const data = await response.json();
...
async function obtenerPrestamosEmpleado(numeroEmpleado) {
    try {
        const response = await fetch(`/api/empleados/prestamos_empleado?numeroEmpleado=${numeroEmpleado}`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
        const data = await response.json();
...
async function obtenerServiciosPacEmpleado(numeroEmpleado) {
    try {
        const response = await fetch(`/api/empleados/serviciosPac_empleado?numeroEmpleado=${numeroEmpleado}`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
        const data = await response.json();
...
async function obtenerAsistenciaReunionesIntegracionEmpleado(numeroEmpleado) {
    try {
        const response = await fetch(`/api/empleados/reunionesIntegracion_empleado?numeroEmpleado=${numeroEmpleado}`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
        const data = await response.json();
...
async function listarNivelesEstudio() {
    try {
        const response = await fetch(`/api/niveles_estudio`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
        const data = await response.json();
...
async function listarCiudades() {
    try {
        const response = await fetch(`/api/pueblos_ciudades`, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        });
        const data = await response.json();

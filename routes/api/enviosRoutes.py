...
api_envios = Blueprint('api_envios', __name__)

# Ruta para obtener todos los envíos
@api_envios.route('/', methods=['GET'])
def listar_envios():
...
@api_envios.route('/', methods=['DELETE'])
def eliminar_envio():
...
#////CAJAS////
@api_envios.route('/cajas', methods=['GET'])
def listar_cajas():
    """Endpoint para obtener todos los registros"""
...
@api_envios.route('/cajas_contenido', methods=['GET'])
...
# Ruta para insertar un nuevo envío
@api_envios.route('/cajas', methods=['POST'])
def crear_caja():
    """Endpoint para insertar un registro"""
    data = request.json
    pkEnvio = data.get('pkEnvio')
...
@api_envios.route('/cajas', methods=['PUT'])
def editar_caja():
    """Endpoint para insertar un registro"""
    data = request.json
...
@api_envios.route('/cajas', methods=['DELETE'])
def eliminar_caja():
    """Endpoint para eliminar un registro"""
    try:
        data = request.json

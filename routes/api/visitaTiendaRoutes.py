...
api_visitas = Blueprint('api_visitas', __name__)

# Ruta para obtener todas las visitas a tienda
@api_visitas.route('/', methods=['GET'])
...
@api_visitas.route('/', methods=['POST'])
...
@api_visitas.route('/', methods=['DELETE'])

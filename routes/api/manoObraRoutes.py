...
api_manosObra = Blueprint('api_manosObra', __name__)

# Ruta para obtener todas las manos de obra
@api_manosObra.route('/', methods=['GET'])
...
@api_manosObra.route('/', methods=['POST'])
def crear_mano_obra():
...
@api_manosObra.route('/', methods=['PUT'])
...
@api_manosObra.route('/', methods=['DELETE'])

...
api_empleados = Blueprint('api_empleados', __name__)


#Ruta endpoints
@api_empleados.route('/', methods=['GET'])
def listar_empleados():
    """Endpoint para obtener todos los registros"""
    empleados = Empleado.listar_empleados()
    return jsonify(empleados), 200

@api_empleados.route('/empleado', methods=['GET'])
def otener_empleado():
    """Endpoint para obtener todos los registros"""
...
@api_empleados.route('/', methods=['POST'])
def crear_empleado():
...
@api_empleados.route('/colaborador', methods=['POST'])
...
@api_empleados.route('/', methods=['PUT'])
def editar_empleado():
...
@api_empleados.route('/', methods=['DELETE'])
...
@api_empleados.route('/cursos_empleado', methods=['GET'])
...
@api_empleados.route('/permisos_empleado', methods=['GET'])
...
@api_empleados.route('/oportunidad_empleado', methods=['GET'])
...
@api_empleados.route('/prestamos_empleado', methods=['GET'])
...
@api_empleados.route('/serviciosPac_empleado', methods=['GET'])
...
@api_empleados.route('/reunionesIntegracion_empleado', methods=['GET'])
...
@api_empleados.route('/asistencia_cursos', methods=['POST'])
...
@api_empleados.route('/oportunidad_empleado', methods=['POST'])
...
@api_empleados.route('/reunionesIntegracion_empleado', methods=['POST'])
...
@api_empleados.route('/asistencia_cursos', methods=['PUT'])
...
@api_empleados.route('/oportunidad_empleado', methods=['PUT'])
...
@api_empleados.route('/reunionesIntegracion_empleado', methods=['PUT'])
...
@api_empleados.route('/cursos_empleado', methods=['DELETE'])
...
@api_empleados.route('/oportunidad_empleado', methods=['DELETE'])
...
@api_empleados.route('/reunionesIntegracion_empleado', methods=['DELETE'])

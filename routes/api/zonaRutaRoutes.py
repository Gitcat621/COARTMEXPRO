...
api_zonasRuta = Blueprint('api_zonasRuta', __name__)

# Ruta para obtener todas las zonas de ruta
@api_zonasRuta.route('/', methods=['GET'])
...
@api_zonasRuta.route('/', methods=['POST'])
def crear_zona_ruta():
...
@api_zonasRuta.route('/', methods=['PUT'])
...
@api_zonasRuta.route('/', methods=['DELETE'])

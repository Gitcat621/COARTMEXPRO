...
api_nivelesEstudio = Blueprint('api_nivelesEstudio', __name__)

# Ruta para obtener todos los niveles de estudio
@api_nivelesEstudio.route('/', methods=['GET'])
...
@api_nivelesEstudio.route('/', methods=['POST'])
...
@api_nivelesEstudio.route('/', methods=['PUT'])
...
@api_nivelesEstudio.route('/', methods=['DELETE'])

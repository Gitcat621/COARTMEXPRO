...
api_serviciosVehiculo = Blueprint('api_serviciosVehiculo', __name__)

# Ruta para listar todos los servicios de vehículo
@api_serviciosVehiculo.route('/', methods=['GET'])
def listar_servicios_vehiculo():
    """Endpoint para obtener todos los registros"""
    servicios = ServicioVehiculo.listar_servicios_vehiculo()
    return jsonify(servicios), 200

@api_serviciosVehiculo.route('/servicio_vehiculo', methods=['GET'])
...
@api_serviciosVehiculo.route('/', methods=['POST'])
...
@api_serviciosVehiculo.route('/', methods=['PUT'])
...
@api_serviciosVehiculo.route('/', methods=['DELETE'])

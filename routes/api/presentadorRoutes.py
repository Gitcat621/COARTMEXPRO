...
api_presentadores = Blueprint('api_presentadores', __name__)

# Rutas endpoints
@api_presentadores.route('/', methods=['GET'])
...
@api_presentadores.route('/', methods=['POST'])
...
@api_presentadores.route('/', methods=['PUT'])
...
@api_presentadores.route('/', methods=['DELETE'])

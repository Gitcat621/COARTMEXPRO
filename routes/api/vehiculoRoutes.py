...
api_vehiculos = Blueprint('api_vehiculos', __name__)

# Ruta para obtener todos los vehículos
@api_vehiculos.route('/', methods=['GET'])
...
# Ruta para obtener todos los vehículos
@api_vehiculos.route('/vehiculo', methods=['GET'])
...
@api_vehiculos.route('/', methods=['POST'])
def crear_vehiculo():
...
@api_vehiculos.route('/', methods=['PUT'])
def editar_vehiculo():
...
@api_vehiculos.route('/', methods=['DELETE'])

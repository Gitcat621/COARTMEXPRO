...
api_articulos = Blueprint('api_articulos', __name__)

@api_articulos.route('/', methods=['GET'])
...
@api_articulos.route('/inventario', methods=['GET'])
...
@api_articulos.route('/', methods=['POST'])
def crear_articulo():
...
@api_articulos.route('/', methods=['PUT'])
def editar_articulo():
...
@api_articulos.route('/', methods=['DELETE'])

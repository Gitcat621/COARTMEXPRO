...
api_beneficios = Blueprint('api_beneficios', __name__)

# Ruta para obtener todos los beneficios
@api_beneficios.route('/', methods=['GET'])
...
@api_beneficios.route('/', methods=['POST'])
def crear_beneficio():
...
@api_beneficios.route('/', methods=['PUT'])
...
@api_beneficios.route('/', methods=['DELETE'])

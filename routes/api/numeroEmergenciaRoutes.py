...
api_numerosEmergencia = Blueprint('api_numerosEmergencia', __name__)

# Ruta para obtener todos los números de emergencia
@api_numerosEmergencia.route('/', methods=['GET'])
...
@api_numerosEmergencia.route('/', methods=['POST'])
...
@api_numerosEmergencia.route('/', methods=['PUT'])
...
@api_numerosEmergencia.route('/', methods=['DELETE'])

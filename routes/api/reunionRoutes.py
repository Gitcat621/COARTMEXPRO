...
api_reuniones = Blueprint('api_reuniones', __name__)

# Ruta para obtener todas las reuniones
@api_reuniones.route('/', methods=['GET'])
...
@api_reuniones.route('/', methods=['POST'])
def crear_reunion():
...
@api_reuniones.route('/', methods=['PUT'])
def editar_reunion():
...
@api_reuniones.route('/', methods=['DELETE'])

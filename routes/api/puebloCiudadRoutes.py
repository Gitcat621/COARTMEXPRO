...
api_pueblosCiudades = Blueprint('api_pueblosCiudades', __name__)

@api_pueblosCiudades.route('/', methods=['GET'])
def listar_pueblosCiudades():
    """Endpoint para obtener todos los registros"""
    pueblosCiudades = PuebloCiudad.listar_pueblosCiudades()
    return jsonify(pueblosCiudades), 200

@api_pueblosCiudades.route('/', methods=['POST'])
...
@api_pueblosCiudades.route('/', methods=['PUT'])
...
@api_pueblosCiudades.route('/', methods=['DELETE'])

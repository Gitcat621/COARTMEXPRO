...
api_funcionesPuesto = Blueprint('api_funcionesPuesto', __name__)

# Ruta para obtener todas las funciones de puesto
@api_funcionesPuesto.route('/', methods=['GET'])
...
@api_funcionesPuesto.route('/', methods=['POST'])
...
@api_funcionesPuesto.route('/', methods=['PUT'])
...
@api_funcionesPuesto.route('/', methods=['DELETE'])

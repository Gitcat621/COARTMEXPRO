...
api_gastos = Blueprint('api_gastos', __name__)

@api_gastos.route('/', methods=['GET'])
def listar_gastos():
...
@api_gastos.route('/', methods=['DELETE'])
def eliminar_gasto():

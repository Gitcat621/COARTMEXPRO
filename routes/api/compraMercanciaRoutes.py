...
api_comprasMercancia = Blueprint('api_comprasMercancia', __name__)

@api_comprasMercancia.route('/', methods=['GET'])
def listar_compras():
...
@api_comprasMercancia.route('/', methods=['POST'])
def crear_compra():
...
@api_comprasMercancia.route('/', methods=['PUT'])
def editar_compra():
...
@api_comprasMercancia.route('/', methods=['DELETE'])
def eliminar_compra():

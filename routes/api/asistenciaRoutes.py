...
api_asistencias = Blueprint('api_asistencias', __name__)

@api_asistencias.route('/', methods=['GET'])
...
@api_asistencias.route('/resumen_asistencias', methods=['GET'])
...
@api_asistencias.route('/observaciones', methods=['GET'])
...
@api_asistencias.route('/', methods=['POST'])
...
@api_asistencias.route('/observaciones', methods=['POST'])
...
@api_asistencias.route('/', methods=['PUT'])
...
@api_asistencias.route('/observaciones', methods=['PUT'])
...
@api_asistencias.route('/', methods=['DELETE'])

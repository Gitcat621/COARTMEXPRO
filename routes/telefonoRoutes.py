...
def listar_telefonos():
    ...
    telefonos = TelefonoController.listar_telefonos()
...
def crear_telefono():
    ...
    if TelefonoController.crear_telefono(numeroTelefono):
...
def editar_telefono():
    ...
    try:
        ...
        if TelefonoController.editar_telefono(pkTelefono, numeroTelefono):
...
def eliminar_telefono():
    ...
    try:
        ...
        if TelefonoController.eliminar_telefono(pkTelefono):
